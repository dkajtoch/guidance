...
{{~/if~}}""",
    ...
    def __call__(self, *args, asynchronous=False, **kwargs):
        ...
        Note that this is a convenience wrapper so you don't have to
        call session(), for higher performance across multiple calls,
...
class CallableAnswer:
    ...
    def __kwdefaults__(self):
        """We build this lazily in case the user wants to handle validation
        errors themselves."""
